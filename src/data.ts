...
export const roleTemplates: Record<string, Perms> = {
  super: { ...allFull },
  // Admin = full access to every module, and can invite/manage members (users:2),
  // but is NOT a super admin: no access grant/revoke drawer and not a petty-cash
  // first approver — those are gated on users:3 (see Users.tsx / can_petty_super).
  admin: { ...allFull, users: 2 },
